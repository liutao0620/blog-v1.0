...
<article class="page-container">
	<form class="form form-horizontal" id="form-rule-add" method="post" action="">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $info['icon']?>" placeholder="请使用矢量图标代码" id="icon" name="icon">
			</div>
		</div>
		...
		<select class="select" name="p_id" size="1">
			<option value="0">顶级分类</option>
					<?php foreach($list as $v){?>
						<option value="<?php echo $v['id']?>" <?php echo $v['id']==$info['p_id']?'selected':''?>>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="is_show" type="radio" id="sex-1" value="0" <?php echo $info['is_show']==0?'checked':''?> >
					<label for="sex-1">显示</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="sex-2" name="is_show" value="1" <?php echo $info['is_show']==1?'checked':''?>>

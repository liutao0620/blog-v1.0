...
<div class="page-container">
	<form action="/admin/tag/taglist.html" method="get">
		<div class="text-c">
			<input type="text" value=""  class="input-text" style="width:250px" placeholder="输入标签名称" id="" name="search">
			<button type="submit" class="btn btn-success" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜标签</button>
		</div>
	</form>
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="_add('添加标签','/admin/tag/add.html','400','200')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加标签</a>
		</span>
	</div>
	<table class="table table-border table-bordered table-bg">
		<thead>
		<tr>
			<th scope="col" colspan="3">栏目列表</th>
		</tr>
		<tr class="text-c">
			<th width="40">ID</th>
		...
		<?php foreach($list as $v){?>
			...
			<td>
				<a title="编辑" href="javascript:;"
				   onclick="_edit('编辑栏目','/admin/tag/edit/id/<?php echo $v['id']?>.html','400','200')" class="ml-5" style="text-decoration:none">
					<i class="Hui-iconfont">&#xe6df;</i></a>
				<a title="删除" href="javascript:;" onclick="_delete(this,<?php echo $v['id']?>,'/admin/tag/delete')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
		</tr>
		<?php }?>		
				</tbody>
	</table>

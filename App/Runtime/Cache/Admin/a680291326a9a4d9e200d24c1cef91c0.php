	...
	<form  class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请数据角色分组的名称，如：系统管理员" id="roleName" name="title">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入角色分组的描述信息，不超过255个字符" id="description" name="description">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<?php foreach($list as $v){?>
				<dl class="permission-list">
					<dt>
						<label>
							<input type="checkbox" value="<?php echo $v['id']?>" name="ids" id="user-Character-1"><?php echo $v['title']?>
						</label>
					</dt>					
					<dd>					
						<dl class="cl permission-list2">						
							<dd>
							<?php foreach($info as $v1){if($v1['p_id']==$v['id']){ ?>				<label class="">
									<input type="checkbox" value="<?php echo $v1['id'];?>" name="ids" id="user-Character-1-0-0">
									<?php echo $v1['title'];?>
								</label>
                            <?php } }?>
							</dd>						
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<button class="btn btn-primary radius" type="button" value="" onclick="sform()">&nbsp;&nbsp;提交&nbsp;&nbsp;</button>
			</div>
		</div>
	</form>
</article>

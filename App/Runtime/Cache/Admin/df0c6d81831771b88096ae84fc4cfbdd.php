    ...
    <form class="form form-horizontal" id="form-admin-add" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="status" type="radio" id="sex-1" checked value="1" <?php echo $info['status']==1?'checked':''?>>
                    <label for="sex-1">已启用</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" name="status" value="2" <?php echo $info['status']==2?'checked':''?>>
                    <label for="sex-2">已禁用</label>
                </div>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> 
                <span class="select-box" style="width:150px;">
			         <select class="select" name="rule_id" size="1">
                                <option value='' >请选择角色</option>
                                <?php foreach($list as $v){?>
                                    <option value="<?php echo $v['id']?>" <?php echo $res[0]['id']==$v['id'] ?'selected':''?> > <?php echo $v['title']?>
                                    </option>
                                <?php }?>    
                    </select>
			     </span> 

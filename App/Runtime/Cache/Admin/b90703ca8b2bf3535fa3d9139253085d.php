...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="_add('添加栏目','/admin/type/add.html','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加栏目</a>
			<?php echo str_repeat('&nbsp;',220);?>
		</span>
		<span class="l" >
			<a href="javascript:;" class="btn btn-primary radius" id='order' onclick="_order()"><i class="Hui-iconfont">&#xe675;</i> 排序</a>
		</span>
	</div>
...
<form id="singcms-listorder">
	<table class="table table-border table-bordered table-bg">
		...
		<tr>
			<th scope="col" colspan="7">栏目列表</th>
		</tr>
		<tr class="text-c">
			<th width="40">ID</th>
		...
		<?php foreach($list as $k => $v){?>
			<tr class="text-c">
				...
				<td align="left" style="text-align: left; padding-left: 10px">
					&nbsp;&nbsp;&nbsp;&nbsp;<?php echo str_repeat('--',$v['lev']*4); echo $v['type_name']?>
				</td>
				<td><?php echo $v['model_id']?></td>
				
				<td><input size=4 type='text'  name="listorder[<?php echo $v['id']?>]" value="<?php echo $v['order_by']?>"/></td><!--6.7-->
				<td>
					<a title="编辑" href="javascript:;" onclick="_edit('编辑栏目','/admin/type/edit/id/<?php echo $v['id']?>.html','','510')" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6df;</i></a>
					<a title="删除" href="javascript:;" onclick="_delete(this,<?php echo $v['id']?>, '/admin/type/delete')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
				</td>
			</tr>
		<?php }?>		
				</tbody>
...
var SCOPE = {
    'listorder_url':'/admin/type/listorder',

...
<section class="container">
	...
	<div class="content">
		<header class="archive-header"> 
			<h1><?php echo ($info['res']['type_name']); ?></h1>
		</header>
		<?php if(is_array($info['article'])): $i = 0; $__LIST__ = $info['article'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><article class="excerpt excerpt-nothumbnail">
				<script src="<?php echo ($vo["git_url"]); ?>"></script>
